...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		...
		register_sidebar( array(
            'name'          => __( 'Footer-top-menu', 'understrap' ),
            'id'            => 'footer-top',
            'description'   => __( 'Footer top widget area', 'understrap'),
        ...
        register_sidebar( array(
            'name'          => __( 'Footer-top-mail-chimp', 'understrap' ),
            'id'            => 'footer-top-mail-chimp',
            'description'   => __( 'Footer top widget area', 'understrap'),
            'before_widget' => '<div class="copyright-text text-center">',
            'after_widget'  => '</div>',
            'before_title'  => '',
        ...
        register_sidebar( array(
            ...
            'id'            => 'footer-bottom',
            'description'   => __( 'Footer bottom widget area', 'understrap'),
            'before_widget' => '',
            'after_widget'  => '',
            'before_title'  => '',
            'after_title'   => '',
        ...
        register_sidebar( array(
            'name'          => __( 'Families-project', 'understrap' ),
            'id'            => 'families-project',
            'description'   => __( 'Families widget area', 'understrap'),
            'before_widget' => '',
            'after_widget'  => '',
            'before_title'  => '',
            'after_title'   => '',
